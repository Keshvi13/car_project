      ...
      body: FutureBuilder<http.Response>(
          builder: (context, snapshot) {
            if (snapshot.data != null && snapshot.hasData) {
              print(
                  "count ${jsonDecode(snapshot.data!.body.toString()).length}");
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                children: [
                                  ...
                                  Padding(
                                      padding:
                                          EdgeInsets.only(left: 25, top: 60)),
                                  CircleAvatar(
                                    radius: 15,
                              ...
                              Column(
                                children: [
                                  Padding(
                                    padding:
                                        EdgeInsets.only(left: 15, top: 590),
                                  ),
                                  Container(
                                      color: Colors.red,
                                      width: 380,
